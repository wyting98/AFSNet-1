...
from utils.utils_map import get_coco_map, get_map, get_classes
from smenet_inld import *
...
if __name__ == "__main__":
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        net = SMENet_inld(confidence=confidence, nms_iou=nms_iou)
